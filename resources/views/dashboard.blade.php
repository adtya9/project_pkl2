...
<div class = "flex flex-col items-center mt-6">                        
     ...
     <div class = "flex gap-4 justify-center flex-wrap">
         ...
         <a href = "{{ route('bagianpkl.index') }}" class = "bg-[#1f3a93] rounded-lg text-center font-semibold py-4 w-40 text-white">Bagian PKL</a> <a href = "{{ route('siswa.index') }}" class = "bg-[#e67e22] rounded-lg text-white w-40 py-4 font-semibold text-center">Siswa</a>
        <a href = "{{ route('pembimbingsekolah.index') }}" class = "bg-[#1f3a93] text-white text-center font-semibold py-4 w-40 rounded-lg">Pembimbing Sekolah</a> <a href = "{{ route('pembimbingpkl.index') }}" class = "bg-[#e67e22] text-white text-center font-semibold rounded-lg py-4 w-40">Pembimbing PKL</a> 
