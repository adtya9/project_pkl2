...
@section('title','Tambah Data Bagian PKL')
...
<div class = "bg-[#fffdf2] min-h-screen flex items-start justify-center mt-32">
    ...
    <div class = "bg-white rounded-lg p-8 border border-gray-400">
        ...
        <h1 class = "text-2xl font-bold mb-6">Tambah Data Bagian PKL</h1>

        <form action = "{{ route('bagianpkl.store') }}" method="POST" class = "mt-6">
            @csrf

            <table cellpadding = "8">
                <tr>
                    <td class = "pr-4">Nama Bagian PKL : </td>
                    <td><input type = "text" name = "nama_bagian" class = "h-[32px] rounded w-[230px] border border-gray-400 px-2
                        text-[15px]"></td>
                </tr>
