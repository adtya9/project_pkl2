...
<div class = "bg-[#fffdf2] min-h-screen flex items-start justify-center mt-32">
    ...
    <div class = "bg-white rounded-lg p-8 border border-gray-400">
        ...
        <form id="formTambahJurusan" action = "{{ route('jurusan.store') }}" method="POST" class = "mt-6">
            @csrf

            <table cellpadding = "8">
                <tr>
                    <td class = "pr-4">Nama Jurusan : </td>
                    <td><input type = "text" id="nama_jurusan" name = "nama_jurusan" class = "h-[32px] rounded w-[230px] border border-gray-400 px-2
                        text-[15px]"></td>
                </tr>
